...
Задание:
Используйте `OrderedDict` для создания функции `manage_orders`, 
которая трекает порядок добавления элементов (имя продукта и их количество) 
и может выводить суммарное количество продуктов.
"""
