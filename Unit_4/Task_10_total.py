...
Цель: Разработать систему для отслеживания и анализа изменений в музыкальных плейлистах, используя название песен.
...
4. При каждом новом обновлении отображайте список песен, которые новые или исчезли из ротации. Вычислите, какие песни увеличивают и снижают свою популярность.
...
мы можем использовать Python с его стандартными библиотеками. Вот примерный код решения задачи на Python:"""
